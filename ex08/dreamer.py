...
from assigment.lr_scheduler import ReduceLROnPlateau
import torch
...
classifier = Net()
classifier.load_state_dict(torch.load('best_model_mnist2.pth'))

# select the target class
target_class = 1

# fix the network weights, i.e. disable gradient
