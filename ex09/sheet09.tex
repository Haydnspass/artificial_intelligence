...
% \label{sec:app}
% 
% \subsection{Classification of Fashion-MNIST dataset}
% \includepdf[pages=-]{classification_fmnist} 
% \subsection{t-SNE visualisation}
% \includepdf[pages=-]{t-sne-visualization}
% \subsection{What did the network learn?}
% \lstinputlisting[language=Python]{dreamer.py}
